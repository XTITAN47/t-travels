...
def DatabaseDoesNotExist():
    ...
    cu.execute('CREATE TABLE aeroplanes (flightid varchar(10),flightname varchar(255),departure varchar(255),destination varchar(255),primary key(flightno));')
    cu.execute('CREATE TABLE hotels (hotelid varchar(10),hotelname varchar(255),address varchar(11),rooms varchar(255),primary key(hotelid));')
    ...
    cu.execute('CREATE TABLE airtickets (airticketid varchar(10),user varchar(10),flightno varchar(10),username varchar(255), flightname varchar(255),departure varchar(255),destination varchar(255),primary key(airticketid));')
    cu.execute('CREATE TABLE hoteltickets (hotelticketid varchar(10),user varchar(10),hotelid varchar(10),username varchar(255), hotelname varchar(255),address varchar(255),primary key(hotelticketid));')
    cu.execute('CREATE TABLE bustickets (busticketid varchar(10),user varchar(10),busid varchar(10),username varchar(255),departure varchar(255),destination varchar(255),primary key(busticketid));')
    cu.execute('CREATE TABLE traintickets (trainticketid varchar(10),user varchar(10),trainid varchar(10),username varchar(255),trainname varchar(255),departure varchar(255),destination varchar(255),primary key(trainticketid));')
