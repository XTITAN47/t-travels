...
mydb = mysql.connector.connect(
  host="localhost",
  user="root",
  password="Titan@1067",  database='titan_travels'
)
...
def DatabaseDoesNotExist():
    ...
    cu.execute('CREATE TABLE hoteltickets (hotelticketid varchar(10),user varchar(10),hotelid varchar(10),username varchar(255), hotelname varchar(255),address varchar(255),price int(11),primary key(hotelticketid));')
